...
class LinksParserCron extends LinksAbstractDB {
    ...
    public function get_async_cron($campaign, $type_name = '') {
        ...
        $url = $site_url . '/wp-content/plugins/links_matic/cron/async_cron.php?p=8ggD_23_2D0DSF-F&type=' . $type_name . '&cid=' . $campaign->id;
