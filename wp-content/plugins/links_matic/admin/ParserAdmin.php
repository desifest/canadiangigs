...
class ParserAdmin extends ItemAdmin {
    ...
    public function init() {
        ...
        if ($uid) {
            ...
            include(LINKS_MATIC_PLUGIN_DIR . 'includes/view_url.php');
            return;
        }
        ...
        if ($cid) {
            ...
            if ($curr_tab == 'home') {
                ...
                if ($campaign) {
                    ...
                    include(LINKS_MATIC_PLUGIN_DIR . 'includes/view_parser.php');
                }
                ...
                include(LINKS_MATIC_PLUGIN_DIR . 'includes/find_urls.php');
                ...
                $campaign = $this->mp->get_campaign($cid);
                include(LINKS_MATIC_PLUGIN_DIR . 'includes/edit_arhive.php');
                ...
                include(LINKS_MATIC_PLUGIN_DIR . 'includes/edit_parsing_data.php');
                ...
                include(LINKS_MATIC_PLUGIN_DIR . 'includes/edit_links.php');
                ...
                $campaign = $this->mp->get_campaign($cid);
                include(LINKS_MATIC_PLUGIN_DIR . 'includes/trash_parser.php');
                ...
                $campaign = $this->mp->get_campaign($cid);
                include(LINKS_MATIC_PLUGIN_DIR . 'includes/edit_parser.php');
                ...
                include(LINKS_MATIC_PLUGIN_DIR . 'includes/mlr/' . $mlr_name . '_results.php');
            }
            return;
        }
        ...
        if (!$curr_tab) {
            ...
            include(LINKS_MATIC_PLUGIN_DIR . 'includes/list_parsers.php');
        } else if ($curr_tab == 'urls') {
            // Posts
            ...
            include(LINKS_MATIC_PLUGIN_DIR . 'includes/add_parser.php');
        }
    }
    ...
    public function overview() {
        ...
        include(LINKS_MATIC_PLUGIN_DIR . 'includes/overview.php');
    }
    ...
    public function parser_urls($tabs = '', $url = '', $cid = 0) {
        ...
        include(LINKS_MATIC_PLUGIN_DIR . 'includes/list_urls.php');
    }
    ...
    public function parser_log($tabs = '', $url = '', $cid = 0) {
        ...
        include(LINKS_MATIC_PLUGIN_DIR . 'includes/list_log_parser.php');
    }
