    ...
    public function init() {
        ...
        if ($cid) {
            ...
            if ($curr_tab == 'home') {
                ...
                include(LINKS_MATIC_PLUGIN_DIR . 'includes/view_tor.php');
                ...
                include(LINKS_MATIC_PLUGIN_DIR . 'includes/edit_tor.php');
                ...
                include(LINKS_MATIC_PLUGIN_DIR . 'includes/list_tor_logs.php');
            }
        ...
        if (!$curr_tab) {
            ...
            include(LINKS_MATIC_PLUGIN_DIR . 'includes/list_tor_services.php');
            ...
            include(LINKS_MATIC_PLUGIN_DIR . 'includes/list_tor_agents.php');
            ...
            include(LINKS_MATIC_PLUGIN_DIR . 'includes/list_tor_ips.php');
        } else if ($curr_tab == 'log') {
            // Log
            $append = '&tab=' . $curr_tab;
            $page_url = $url . $append;
            ...
            include(LINKS_MATIC_PLUGIN_DIR . 'includes/add_tor.php');
        }
    }
