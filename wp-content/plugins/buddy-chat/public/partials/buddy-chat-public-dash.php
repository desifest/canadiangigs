...
<div id="buddy-chat-app" :class="[active_users_list]" v-cloak>
	<div v-if="active_users_list=='dash'" id="buddy-chat-buddies" :class="{collapsed: is_collapsed}">
		<div class="buddy-chat-buddies__container">
			<div class="header-container">
				...
				<div class="dropd-group dropd-dr" :class="{active: show_settings}">
					<a class="dropd-control mute" @click.stop="show_settings = !show_settings"><span class="dashicons dashicons-admin-generic"></span></a>
      ...
      <div v-bar="{preventParentScroll: true}">
        <?php echo $buddies; // WPCS: XSS ok. ?>
			...
			<div id="buddy-chat-buddies__collapser" class="buddy-chat-buddies__collapser" @click="toggle_window">
				<div class="collapse-icon">
					<span class="dashicons dashicons-arrow-right-alt2"></span>
				</div>
				<div class="action-text">
					<h5><?php esc_html_e( 'Collapse', 'buddy-chat' ); ?></h5>
				</div>
			</div>
		</div>
	</div>
	<div id="buddy-chat-windows">
		<ul class="bpc-chat-windows-list">
			...
			<li v-if="active_users_list == 'default' || active_users_list == 'popped'" class="chat-window__buddies" :class="{minimized: is_minimized && active_users_list != 'popped'}">
				<div v-if="active_users_list=='popped'" class="dropd-group dropd-tr popped-buddies" :class="{active: show_buddies}">
				...
				<div v-if="active_users_list=='default'" id="buddy-chat-buddies__default" :class="{collapsed: is_collapsed}">
					<div class="buddy-chat-buddies__container">
