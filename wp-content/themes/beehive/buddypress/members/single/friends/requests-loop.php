...
<?php if ( bp_has_members( bp_ajax_querystring( 'friendship_requests' ) . '&include=' . bp_get_friendship_requests() ) ) : ?>
	...
	<ul id="friend-list" class="<?php bp_nouveau_loop_classes(); ?>">
		...
		while ( bp_members() ) :
			...
			<li id="friendship-<?php bp_friend_friendship_id(); ?>" <?php bp_member_class( array( beehive_add_reveal_animation( 'item-entry', false ) ) ); ?> data-bp-item-id="<?php bp_friend_friendship_id(); ?>" data-bp-item-component="members">
