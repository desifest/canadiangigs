		...
		if ( 0 < $item_count ) {
			...
			foreach ( $this->items as $item ) {
				...
				$item = ! empty( $matches )
					...
					: sprintf( '<span>%s</span>', ( is_single() && 'post' === get_post_type() && 'full' === beehive()->layout->get() ) ? apply_filters( 'beehive_full_width_single_post_breadcrumb_trail', esc_html__( 'Single', 'beehive' ) ) : $item );
