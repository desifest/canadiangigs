					...
					<div class="content" id="manage-media-tab">
						<?php if ( have_rtmedia() ) { ?>
							<form class="rtmedia-album-edit rtmedia-bulk-actions" method="post" name="rtmedia_album_edit">
								...
								<a id="rtMedia-galary-prev" class="color-primary" style='<?php echo esc_attr( $display ); ?>' href="<?php echo esc_url( rtmedia_pagination_prev_link() ); ?>">
								...
								<a id="rtMedia-galary-next" class="color-primary" style="<?php echo esc_attr( $display ); ?>" href="<?php echo esc_url( rtmedia_pagination_next_link() ); ?>">
